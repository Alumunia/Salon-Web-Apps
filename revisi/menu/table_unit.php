...
?>
                    ...
                    <tbody>
                     <tr>
						...
						<td><button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteProduk" data-id="<?php echo $row['idProduk'] ?>" data-name="<?php echo $row['namaProduk'] ?>">Hapus</button></td>
...
<td><button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteTraining" data-id="<?php echo $baris['idTraining'] ?>" data-tipe="<?php echo $baris['tipe'] ?>" data-name="<?php echo $baris['namaTraining'] ?>">Hapus</button></td>
...
<?php } ?>
    ...
    $('#deleteProduk').on('show.bs.modal', function (event) {
      ...
      var modal = $(this)
      modal.find('.modal-body p strong').text(name)
    ...
    $('#deleteTraining').on('show.bs.modal', function (event) {
      ...
      var modal = $(this)
      modal.find('.modal-body p strong').text(tipe + " " +name)
      modal.find('.modal-footer form input').val(id)
      modal.find('.modal-footer form label input').val(tipe)
    })    
    </script>
  </body>
</html>
