<?php
	...
	if(empty($qr2)) {
		mysqli_query($con, "INSERT INTO `pelanggan` VALUES ('','$name','$age', '$street', '$prov','$city','$cell1','$cell2','$phone','$bbm','$email','$fb','','$testimoni')");
		$ktp = mysqli_insert_id($con);
	} else if ($qr2){
		$ktp = $qr2['idPelanggan'];
		mysqli_query($con,	"UPDATE pelanggan SET testimoni ='$testimoni' WHERE idPelanggan='$ktp'");
	}
